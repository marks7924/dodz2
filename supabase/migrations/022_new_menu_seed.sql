...
INSERT INTO public.customization_groups (id, name_en, name_ar, min_selected, max_selected) VALUES
  ('g1000000-0000-0000-0000-000000000001', 'Spiciness Level', 'درجة الحرقان', 1, 1);
INSERT INTO public.customization_options (id, group_id, name_en, name_ar, price) VALUES
  ('o1000000-0000-0000-0000-000000000001', 'g1000000-0000-0000-0000-000000000001', 'Original (Cold)', 'عادي (Original)', 0),
  ('o1000000-0000-0000-0000-000000000002', 'g1000000-0000-0000-0000-000000000001', 'Spicy (Hot)', 'حار (Spicy)', 0);

-- Group 2: Combo Meal Upgrade
INSERT INTO public.customization_groups (id, name_en, name_ar, min_selected, max_selected) VALUES
  ('g1000000-0000-0000-0000-000000000002', 'Combo Meal Upgrade', 'وجبة كومبو', 0, 1);
INSERT INTO public.customization_options (id, group_id, name_en, name_ar, price) VALUES
  ('o1000000-0000-0000-0000-000000000003', 'g1000000-0000-0000-0000-000000000002', 'Add Combo (Fries + Drink)', 'تحويل لوجبة كومبو (بطاطس + مشروب)', 70);

-- Group 3: Combo Fries Upgrade
INSERT INTO public.customization_groups (id, name_en, name_ar, min_selected, max_selected) VALUES
  ('g1000000-0000-0000-0000-000000000003', 'Combo Fries Upgrade', 'ترقية البطاطس في الكومبو', 0, 1);
INSERT INTO public.customization_options (id, group_id, name_en, name_ar, price) VALUES
  ('o1000000-0000-0000-0000-000000000004', 'g1000000-0000-0000-0000-000000000003', 'Upgrade to Cheesy Fries', 'ترقية لبطاطس بالجبنة', 45);

-- Group 4: Sandwich Add-ons
INSERT INTO public.customization_groups (id, name_en, name_ar, min_selected, max_selected) VALUES
  ('g1000000-0000-0000-0000-000000000004', 'Sandwich Add-ons', 'إضافات السندوتشات', 0, 10);
INSERT INTO public.customization_options (id, group_id, name_en, name_ar, price) VALUES
  ('o1000000-0000-0000-0000-000000000005', 'g1000000-0000-0000-0000-000000000004', 'Add Liquid Cheddar Cheese', 'إضافة صوص تشيدر سائل ساخن', 25),
  ('o1000000-0000-0000-0000-000000000006', 'g1000000-0000-0000-0000-000000000004', 'Add Smoked Turkey Slice', 'إضافة شريحة تركي مدخن', 30),
  ('o1000000-0000-0000-0000-000000000007', 'g1000000-0000-0000-0000-000000000004', 'Add Spicy Cheddar Fingers', 'إضافة أصابع تشيدر حارة', 40),
  ('o1000000-0000-0000-0000-000000000008', 'g1000000-0000-0000-0000-000000000004', 'Add Mozzarella Bomb', 'إضافة قنبلة موتزاريلًا', 60),
  ('o1000000-0000-0000-0000-000000000009', 'g1000000-0000-0000-0000-000000000004', 'Extra Crispy Chicken Piece', 'قطعة فراخ كريسبي إضافية', 75),
  ('o1000000-0000-0000-0000-000000000010', 'g1000000-0000-0000-0000-000000000004', 'Extra Smashed Beef Patty', 'قطعة برجر لحم سماش إضافية', 65),
  ('o1000000-0000-0000-0000-000000000011', 'g1000000-0000-0000-0000-000000000004', 'Add Extra Dipping Sauce', 'إضافة صوص جانبي خارجي (رانش / بافلو / إلخ)', 20);

-- Group 5: A La Carte Additions
INSERT INTO public.customization_groups (id, name_en, name_ar, min_selected, max_selected) VALUES
  ('g1000000-0000-0000-0000-000000000005', 'A La Carte Additions', 'إضافة قطع منفصلة', 0, 10);
INSERT INTO public.customization_options (id, group_id, name_en, name_ar, price) VALUES
  ('o1000000-0000-0000-0000-000000000012', 'g1000000-0000-0000-0000-000000000005', 'Extra Broasted Chicken Piece', 'قطعة فراخ بروستد إضافية', 88),
  ('o1000000-0000-0000-0000-000000000013', 'g1000000-0000-0000-0000-000000000005', 'Extra Crispy Fillet Piece', 'قطعة فيليه دجاج مقرمش إضافية', 94),
  ('o1000000-0000-0000-0000-000000000014', 'g1000000-0000-0000-0000-000000000005', 'Extra Crispy Tender Piece', 'قطعة تندر كريسبي إضافية', 66),
  ('o1000000-0000-0000-0000-000000000015', 'g1000000-0000-0000-0000-000000000005', 'Extra Brioche Bun', 'خبز بريوش إضافي', 12);

-- Group 6: Milkshake Additions
INSERT INTO public.customization_groups (id, name_en, name_ar, min_selected, max_selected) VALUES
  ('g1000000-0000-0000-0000-000000000006', 'Milkshake Additions', 'إضافات الشيك', 0, 2);
INSERT INTO public.customization_options (id, group_id, name_en, name_ar, price) VALUES
  ('o1000000-0000-0000-0000-000000000016', 'g1000000-0000-0000-0000-000000000006', 'Extra Scoop of Vanilla Ice Cream', 'إضافة بوله آيس كريم إضافية', 25),
  ('o1000000-0000-0000-0000-000000000017', 'g1000000-0000-0000-0000-000000000006', 'Extra Syrup Sauce', 'إضافة اكسترا صوص', 15);
...
INSERT INTO public.menu_item_customization_groups (menu_item_id, group_id) VALUES
  ('f1000000-0000-0000-0000-000000000006', 'g1000000-0000-0000-0000-000000000001'),
  ('f1000000-0000-0000-0000-000000000006', 'g1000000-0000-0000-0000-000000000002'),
  ('f1000000-0000-0000-0000-000000000006', 'g1000000-0000-0000-0000-000000000003'),
  ('f1000000-0000-0000-0000-000000000006', 'g1000000-0000-0000-0000-000000000004'),

  ('f1000000-0000-0000-0000-000000000007', 'g1000000-0000-0000-0000-000000000001'),
  ('f1000000-0000-0000-0000-000000000007', 'g1000000-0000-0000-0000-000000000002'),
  ('f1000000-0000-0000-0000-000000000007', 'g1000000-0000-0000-0000-000000000003'),
  ('f1000000-0000-0000-0000-000000000007', 'g1000000-0000-0000-0000-000000000004'),

  ('f1000000-0000-0000-0000-000000000008', 'g1000000-0000-0000-0000-000000000001'),
  ('f1000000-0000-0000-0000-000000000008', 'g1000000-0000-0000-0000-000000000002'),
  ('f1000000-0000-0000-0000-000000000008', 'g1000000-0000-0000-0000-000000000003'),
  ('f1000000-0000-0000-0000-000000000008', 'g1000000-0000-0000-0000-000000000004'),

  ('f1000000-0000-0000-0000-000000000009', 'g1000000-0000-0000-0000-000000000001'),
  ('f1000000-0000-0000-0000-000000000009', 'g1000000-0000-0000-0000-000000000002'),
  ('f1000000-0000-0000-0000-000000000009', 'g1000000-0000-0000-0000-000000000003'),
  ('f1000000-0000-0000-0000-000000000009', 'g1000000-0000-0000-0000-000000000004'),

  ('f1000000-0000-0000-0000-000000000010', 'g1000000-0000-0000-0000-000000000001'),
  ('f1000000-0000-0000-0000-000000000010', 'g1000000-0000-0000-0000-000000000002'),
  ('f1000000-0000-0000-0000-000000000010', 'g1000000-0000-0000-0000-000000000003'),
  ('f1000000-0000-0000-0000-000000000010', 'g1000000-0000-0000-0000-000000000004'),

  ('f1000000-0000-0000-0000-000000000011', 'g1000000-0000-0000-0000-000000000001'),
  ('f1000000-0000-0000-0000-000000000011', 'g1000000-0000-0000-0000-000000000002'),
  ('f1000000-0000-0000-0000-000000000011', 'g1000000-0000-0000-0000-000000000003'),
  ('f1000000-0000-0000-0000-000000000011', 'g1000000-0000-0000-0000-000000000004'),

  ('f1000000-0000-0000-0000-000000000012', 'g1000000-0000-0000-0000-000000000001'),
  ('f1000000-0000-0000-0000-000000000012', 'g1000000-0000-0000-0000-000000000002'),
  ('f1000000-0000-0000-0000-000000000012', 'g1000000-0000-0000-0000-000000000003'),
  ('f1000000-0000-0000-0000-000000000012', 'g1000000-0000-0000-0000-000000000004');

-- Link Broasted Meals
INSERT INTO public.menu_item_customization_groups (menu_item_id, group_id) VALUES
  ('f1000000-0000-0000-0000-000000000013', 'g1000000-0000-0000-0000-000000000001'),
  ('f1000000-0000-0000-0000-000000000013', 'g1000000-0000-0000-0000-000000000005'),
  ('f1000000-0000-0000-0000-000000000014', 'g1000000-0000-0000-0000-000000000001'),
  ('f1000000-0000-0000-0000-000000000014', 'g1000000-0000-0000-0000-000000000005'),
  ('f1000000-0000-0000-0000-000000000015', 'g1000000-0000-0000-0000-000000000001'),
  ('f1000000-0000-0000-0000-000000000015', 'g1000000-0000-0000-0000-000000000005'),
  ('f1000000-0000-0000-0000-000000000016', 'g1000000-0000-0000-0000-000000000001'),
  ('f1000000-0000-0000-0000-000000000016', 'g1000000-0000-0000-0000-000000000005'),
  ('f1000000-0000-0000-0000-000000000017', 'g1000000-0000-0000-0000-000000000001'),
  ('f1000000-0000-0000-0000-000000000017', 'g1000000-0000-0000-0000-000000000005'),
  ('f1000000-0000-0000-0000-000000000018', 'g1000000-0000-0000-0000-000000000001'),
  ('f1000000-0000-0000-0000-000000000018', 'g1000000-0000-0000-0000-000000000005'),
  ('f1000000-0000-0000-0000-000000000019', 'g1000000-0000-0000-0000-000000000001'),
  ('f1000000-0000-0000-0000-000000000019', 'g1000000-0000-0000-0000-000000000005'),
  ('f1000000-0000-0000-0000-000000000020', 'g1000000-0000-0000-0000-000000000001'),
  ('f1000000-0000-0000-0000-000000000020', 'g1000000-0000-0000-0000-000000000005'),
  ('f1000000-0000-0000-0000-000000000021', 'g1000000-0000-0000-0000-000000000001'),
  ('f1000000-0000-0000-0000-000000000021', 'g1000000-0000-0000-0000-000000000005'),
  ('f1000000-0000-0000-0000-000000000022', 'g1000000-0000-0000-0000-000000000001'),
  ('f1000000-0000-0000-0000-000000000022', 'g1000000-0000-0000-0000-000000000005'),
  ('f1000000-0000-0000-0000-000000000023', 'g1000000-0000-0000-0000-000000000001'),
  ('f1000000-0000-0000-0000-000000000023', 'g1000000-0000-0000-0000-000000000005'),
  ('f1000000-0000-0000-0000-000000000024', 'g1000000-0000-0000-0000-000000000001'),
  ('f1000000-0000-0000-0000-000000000024', 'g1000000-0000-0000-0000-000000000005');

-- Link Shakes
INSERT INTO public.menu_item_customization_groups (menu_item_id, group_id) VALUES
  ('f1000000-0000-0000-0000-000000000043', 'g1000000-0000-0000-0000-000000000006'),
  ('f1000000-0000-0000-0000-000000000044', 'g1000000-0000-0000-0000-000000000006'),
  ('f1000000-0000-0000-0000-000000000045', 'g1000000-0000-0000-0000-000000000006');
